...
submitOn = (e , emailOn) => {
  ...
  if( this.state.email==="balaji@gmail.com"&& this.state.password==="balaji"||this.state.email==="balaji00@gmail.com"&& this.state.password==="balaji" ||this.state.email==="balaji00717112000@gmail.com" && this.state.password==="balaji"){
  alert("welcome "  +  this.state.email[0] + this.state.email[1]  + this.state.email[2]  + this.state.email[3] +  this.state.email[4] + this.state.email[5]);
}
else if(this.state.email==="abipandi@gmail.com"&&this.state.password==="abijith"){
